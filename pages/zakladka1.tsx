...
export default function Zakladka1() {
  return (
    <>
      <Head>
        <title>Zakładka 1 - Przychodnia Psychiatryczna w Krapkowicach</title>
      </Head>
      <ArticleTitle>Zakładka 1</ArticleTitle>
      <ArticleContent>
        <p>
